...
#glm함수에 일반화된 선형모델을 먼저 수행하는 함수, hd ~ sex :성별을 사용하여 심장질환 예측 지정정  ,data=data : 모델에사용될 데이터지정, family="binomial" : 일반화 된 선형의 이항패밀리
#logistic <- glm(hd ~ sex, data=data, family="binomial")  여기 물결표는 심장 질환 HD를 모델링 한다는 의미
