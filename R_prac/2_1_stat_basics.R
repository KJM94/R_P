...
prop.table(table(data$resident2)) # % 구하는 함수
...
# 연구가설(대립가설): 기존 2019년도 고객 불만율과 2019년도 CS교육 후, 불만율에 차이가 있다. 
# 패키지 설치
library(prettyR)
...
# p-value = 0.7242, 유의확률보다 높기 때문에 모수검정인 T검정을 실시한다. : 비모수 검정
# 정규분포 시각화
...
# t검정의 종류
# 1. 단일 표본
# 2. 대응 표본 paired t.test
#    --> 사전 평가
#        <교육>
#    --> 사후 평가
# 3. 독립 표본 independent t.test
#     : 두 개의 그룹
